...
public class RoomSelectCapacity {
	...
	public static void main(String[] args) {
        ...
        try{
            ...
            SelectByCapacity(statement, query);
    ...
    private static void SelectByCapacity(Statement statement, String query) throws SQLException {
