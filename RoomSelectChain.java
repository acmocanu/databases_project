...
public class RoomSelectChain {
	...
	public static void main(String[] args) {
        ...
        try{
            ...
            String query = "SELECT * FROM Room WHERE Hotel_ID IN " +
            			   "(SELECT Hotel_ID FROM hotel WHERE Chain_Name = ?)";
            // Select rooms by hotel chain
            
            SelectByChain(statement, query);
    ...
    private static void SelectByChain(Statement statement, String query) throws SQLException {
