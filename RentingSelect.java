...
public class RentingSelect {
	public static void main(String[] args) {
        ...
        try{
            ...
            SelectFromRenting(statement, query);
    ...
    private static void SelectFromRenting(Statement statement, String query) throws SQLException {
        ResultSet rs = statement.executeQuery(query);

        while (rs.next())
        {
            System.out.println(rs.getString("Renting_ID"));
